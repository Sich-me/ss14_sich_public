...
salv-job-board-name-BountyHivelordRemains = Володар вулику
salv-job-board-name-BountySalvageDiamond = Діаманд

bounty-description-tooth-space-carp = Нам потрібно, щоб ви зібрали зразки зубів космічного коропа. Ви можете знайти цих чуваків на всіляких уламках. Тільки будьте обережні, вони кусаються!
bounty-description-salvage-scrap = Ми досліджуємо вплив глибокого космосу на станції та для цього нам потрібні зразки. Знайдіть на уламках якесь старе сміття та принесіть його нам.
...
bounty-description-tooth-sharkminnow = Нам потрібно, зібрали зразки зубів акулячого малька. Ці чуваки набагато бридкіші за коропів, з якими ви знайомі. Будьте обережні, вони здатні використовувати вашу кров для власного ж відновлення.
...
bounty-description-remains = Нам потрібно, щоб ви отримали зразок кількох ядер Володара вулика. Майте на увазі, що Володарі вулику можуть розмножуватися нескінченно, поки їх ядро у них. Будьте обережні, щоб вони не вбили вас.
bounty-description-plates = Нам потрібно, щоб ти дістав пару шматків шкіри Голіафа. Ці хлопці досить повільні, але будь обережний з щупальцями - їми вони легко повалять вас на землю й... Ви не захочете знати, що буде далі.
